  ...
  <div class="zfb-pay" v-if="show">
    <div class="content">
      ...
      <div class="loading-wrap" v-if="payStatus !== 0">
        <div class="loading">
          <!--加载图标-->
          <img src="../assets/images/loading.png" class="loading-ico" alt v-if="payStatus === 1" />
          <img src="../assets/images/success.png" class="success-ico" alt v-if="payStatus === 2" />
          <!--加载文字-->
...
.keyboard .delete {
  border-bottom: 0;
  background: url(../assets/images/delete.png) no-repeat center #d1d5db;
}
